...
function Home({ section }: HomeProps) {
  return (
    <section
      id="home"
      className="relative h-screen max-h-[70rem] w-full bg-discord-800 flex flex-col justify-center items-center"
    ...
    >
      ...
      <div
        id="home-down-arrow"
        className="text-3xl text-white rotate-90 absolute"
      >
        &gt;
      </div>
    </section>
